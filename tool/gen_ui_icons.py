...
def folder(x=2.6, y=5.8, w=18.8, h=13.0, tab=6.4, step=2.6):
...
def_('restore', [S(arc(12, 12, 7.8, 128, 400, 40)),
                 S(P((4.4, 9.4), (3.6, 14.4), (8.6, 15.0))),
                 S(seg(12, 8.2, 12, 12.4), SD),
                 S(seg(12, 12.4, 15.2, 14.0), SD)])
...
def_('private', [S(P((3.4, 9.2), (12, 3.6), (20.6, 9.2))),
                  S(rr(5.8, 9.2, 12.4, 10.8, 2.8)),
                  S(seg(10.0, 14.2, 14.0, 14.2), SD)])
...
def_('reader', [S(P((12, 5.2), (4.2, 5.2), (4.2, 19.0), (12, 19.0))),
                S(P((12, 5.2), (19.8, 5.2), (19.8, 19.0), (12, 19.0))),
                S(seg(12, 5.2, 12, 19.0), SD),
                S(seg(6.6, 9.2, 9.8, 9.2), SD), S(seg(14.2, 9.2, 17.4, 9.2), SD),
                S(seg(6.6, 12.4, 9.8, 12.4), SD)])
...
def_('auto', [S(circle(12, 12, 8.2)),
              Fl(join(arc(12, 12, 8.2, -90, 90, 40),
                      P((12, 20.2), (12, 3.8)))),
              S(seg(5.0, 5.6, 6.6, 7.2), SD),
              S(seg(3.2, 9.4, 5.2, 9.8), SD),
              S(seg(7.6, 3.4, 8.0, 5.4), SD)])
def_('contrast', [S(circle(12, 12, 8.4)),
                  Fl(join(arc(12, 12, 8.4, -90, 90, 40),
                          P((12, 20.4), (12, 3.6))))])
def_('palette', [S(join(arc(12, 12.8, 8.4, 165, 15, 40),
                        P((12.6, 4.6), (12.6, 7.4), (9.2, 9.4), (6.4, 12.6)))),
                 S(circle(7.6, 9.4, 1.05), SD), S(circle(12.0, 7.4, 1.05), SD),
                 S(circle(16.2, 9.2, 1.05), SD), S(circle(7.2, 14.4, 1.05), SD)])
...
def_('location', [S(P((12, 21.2), (6.4, 13.4), (6.4, 9.2), (12, 3.2),
                      (17.6, 9.2), (17.6, 13.4))),
                  S(circle(12, 9.4, 2.4), SD)])
